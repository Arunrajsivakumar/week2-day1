...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		if (driver.getTitle().equals("View Lead | opentaps CRM")) {
			System.out.println("Lead Created sussfully");
			driver.findElement(By.linkText("Duplicate Lead")).click();

			driver.findElement(By.id("createLeadForm_companyName")).clear();
			driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Leaf");
			driver.findElement(By.id("createLeadForm_firstName")).clear();
			driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Developer");
			driver.findElement(By.name("submitButton")).click();
			if (driver.getTitle().equals("View Lead | opentaps CRM")) {
				System.out.println("Dupicate Created successfully");
			}
		} else {
